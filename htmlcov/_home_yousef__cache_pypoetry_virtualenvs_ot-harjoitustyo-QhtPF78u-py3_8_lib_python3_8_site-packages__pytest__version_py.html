...
<head>
    ...
    <title>Coverage for /home/yousef/.cache/pypoetry/virtualenvs/ot-harjoitustyo-QhtPF78u-py3.8/lib/python3.8/site-packages/_pytest/_version.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/yousef/.cache/pypoetry/virtualenvs/ot-harjoitustyo-QhtPF78u-py3.8/lib/python3.8/site-packages/_pytest/_version.py</b> :
...
<div id="source">
    ...
    <p id="t4" class="run"><span class="n"><a href="#t4">4</a></span><span class="t"><span class="nam">version</span> <span class="op">=</span> <span class="str">'6.2.3'</span>&nbsp;</span><span class="r"></span></p>
    <p id="t5" class="run"><span class="n"><a href="#t5">5</a></span><span class="t"><span class="nam">version_tuple</span> <span class="op">=</span> <span class="op">(</span><span class="num">6</span><span class="op">,</span> <span class="num">2</span><span class="op">,</span> <span class="num">3</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
